...
const COMPANION_TABS = [
  ...
  },
  {
    ...
    icon: "☕",
    label: "Casual Dating",
    desc: "Relaxed no-pressure vibes",
    color: "#0891B2",
    bg: "#CFFAFE",
  },
  {
...
export default function Explore() {
  ...
  const handleTabChange = (key) => {
    setActiveTab(key);
    setFilters(prev => ({ ...prev, intent: key }));
    fetchUsers(key);
  };
      ...
      <div className="container">
        ...
        <div className="explore-header">
          <div>
            ...
            <p className="text-muted">{users.length - currentIdx} profiles remaining</p>
          </div>
        ...
        <div className="companion-cards-section">
          <div className="companion-cards-header">
            <div>
              ...
              <p className="companion-cards-sub">Choose a companion type to filter profiles instantly</p>
            </div>
          </div>
          <div className="companion-cards-strip">
            {COMPANION_TABS.map((tab) => (
              ...
              >
                ...
                {activeTab === tab.key && (
                  <span className="ccard-check">✓</span>
                )}
              </button>
            ))}
          </div>
        ...
        {showFilters && (
          <div className="filters-panel animate-fade-in">
            ...
            <button className="btn btn-primary btn-sm" onClick={fetchUsers}>Apply Filters</button>
          </div>
        )}
        ...
        <div className="explore-area">
          {loading ? (
            ...
            <div className="no-more-card card">
              ...
              <button className="btn btn-primary" onClick={() => { setCurrentIdx(0); fetchUsers(); }}>
                🔄 Refresh Profiles
              </button>
            </div>
          ) : (
              ...
              <div className="profile-card">
                ...
                <div className="profile-info">
                  ...
                  {current.location?.city && (
                    <p className="profile-location">📍 {current.location.city}</p>
                  )}
                ...
                <div className="profile-actions">
                  <button className="action-btn pass-btn" onClick={handlePass} title="Pass">
                    ✕
                  </button>
                  <button className="action-btn super-btn" onClick={() => toast.info("Super like saved! ⭐")} title="Super Like">
                    ⭐
                  </button>
            ...
            <div className="explore-progress">
              <div className="progress">
                <div
                  ...
                  style={{ width: `${((currentIdx) / users.length) * 100}%` }}
                />
              </div>
        ...
        <div className="modal-backdrop" onClick={() => setMatchModal(null)}>
          <div className="modal match-modal animate-scale-in" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="match-actions">
              <button className="btn btn-primary" onClick={() => { setMatchModal(null); }}>
                💬 Send Message
              </button>
